...
require MODX_CORE_PATH . 'model/modx/processors/element/snippet/create.class.php';

class mxSnippetCreateProcessor extends modSnippetCreateProcessor {
...
return 'mxSnippetCreateProcessor';