...
require MODX_CORE_PATH . 'model/modx/processors/element/template/create.class.php';

class mxTemplateCreateProcessor extends modTemplateCreateProcessor {
...
return 'mxTemplateCreateProcessor';